...
public class AliPayCommonUtils {
     ...
     * 支付宝支付跳转页面公共方法
     */
    public static String skipAlipayPayment(String mergeNo, Long amountPrice,String payType) throws Exception{
        //获得初始化的AlipayClient
        ...
        //商品描述，可空
        String body = "";
        String encode = URLEncoder.encode(payType, "GBK");
