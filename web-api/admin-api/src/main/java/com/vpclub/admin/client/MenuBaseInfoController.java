...
//			MenuBaseInfoEntity parentMenuEntity = menuBaseInfoDaoService.selectById(menuBaseInfoEntity.getParentId());
...
//			MenuBaseInfoEntity parentMenu = menuBaseInfoDaoService.selectById(menu.getParentId());
